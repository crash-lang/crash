...
pub struct Import {
    ...
    imports: Vec<ExpressionType>
}

define_statement!(Import);

impl Import {
    pub fn new(position: TokenPosition, imports: Vec<ExpressionType>) -> Self {
        Self { position, imports }
    }

    pub fn imports(&self) -> &Vec<ExpressionType> {
        &self.imports
    }
}